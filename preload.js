...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  updateDiskImageSettings: (patch) => ipcRenderer.invoke('diskImage:updateSettings', patch || {}),
  chooseDiskImagePath: () => ipcRenderer.invoke('diskImage:chooseImage'),
  mountDiskImage: (opts) => ipcRenderer.invoke('diskImage:mount', opts || {}),
  unmountDiskImage: (opts) => ipcRenderer.invoke('diskImage:unmount', opts || {}),
  listBlockedDiskImageApps: () => ipcRenderer.invoke('diskImage:listBlockedApps'),
